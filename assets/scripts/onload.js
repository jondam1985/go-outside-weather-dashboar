...
$("document").ready(function () {
    ...
    for (var key in citiesObj) {
        console.log(key);
        pastCities.prepend($("<p>").text(key).attr("class", "previous"));
    }
...
function getCoordinates(Position) {
    ...
    var queryUrlCurrent = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&APPID=e350fae665123f0371f27b40b295a031";
    ...
    $.ajax({
        ...
        $.ajax({
            url: "https://api.openweathermap.org/data/2.5/uvi?APPID=e350fae665123f0371f27b40b295a031&lat=" + lat + "&lon=" + lon,
            method: "GET"
        }).then(function (response) {
            console.log(response);
            uvIndex.text(response.value)
            //Query UL for forecast weather
            var queryUrlForecast = "https://api.openweathermap.org/data/2.5/forecast?lat=" + lat + "&lon=" + lon + "&APPID=e350fae665123f0371f27b40b295a031";
